...
<div class="mt-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 lg:rounded-3xl lg:p-6">
  <h3 class="text-sm font-semibold text-slate-900 dark:text-white lg:text-base">Add Entry</h3>
  ...
  <div class="mt-4 space-y-3">
    {#each snippets as snippet, sIndex}
      <div class="grid gap-3 sm:grid-cols-[1fr_2fr_auto]">
        ...
        />
        <button
          class="rounded-2xl border border-slate-200 px-4 py-3 text-xs font-semibold text-slate-500 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800 sm:px-3 sm:py-2 lg:rounded-3xl lg:px-4 lg:py-2.5"
