...
<header
  class="mx-auto flex max-w-7xl items-center justify-between gap-4 rounded-2xl bg-white/90 p-4 shadow-sm backdrop-blur dark:bg-slate-900/70 lg:rounded-3xl lg:p-6"
>
  <div>
