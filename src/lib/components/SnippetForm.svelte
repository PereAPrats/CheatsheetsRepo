...
<div class="mt-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 lg:rounded-3xl lg:p-6">
  <h3 class="text-sm font-semibold text-slate-900 dark:text-white lg:text-base">Add Snippet</h3>
  <div class="mt-3 space-y-3">
    <div>
      <label class="text-xs font-medium text-slate-500 dark:text-slate-400" for="entry-select">Entry</label>
      <select
        id="entry-select"
        class="mt-1 w-full rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-600 shadow-sm dark:border-slate-700 dark:bg-slate-950 dark:text-slate-200 lg:rounded-3xl lg:px-4 lg:py-3"
  ...
  <div class="mt-4 flex flex-col gap-2 sm:flex-row">
    <button
      class="w-full rounded-2xl bg-sky-500 px-4 py-3 text-sm font-semibold text-white transition hover:bg-sky-400 disabled:opacity-50 sm:w-auto sm:py-2 lg:rounded-3xl lg:px-6 lg:py-3"
    ...
    <button
      class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 sm:w-auto sm:py-2 lg:rounded-3xl lg:px-6 lg:py-3"
      on:click={onClose}
    >
      Cancel
    </button>
